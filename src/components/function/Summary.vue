...
class Summary extends VueBase {
  get funcId () {
    if (this.data) { return this.data.id } else { return '' }
  }

  get funcName () {
    if (this.data) { return this.data.name } else { return '' }
  }

  get funcMethod () {
    if (this.data) { return this.data.method } else { return '' }
  }

  get funcPath () {
    if (this.data) { return this.data.path } else { return '' }
  }

  get funcFullPath () {
    if (this.data) { return this.data.fullPath } else { return '' }
  }
